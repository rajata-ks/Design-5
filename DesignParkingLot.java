// Time Complexity :park(): log(mn)
//                  unpark(): log(mn)
//                  getNextAvailable():0(1)
//                  addParkingSpot():log(mn);
...
class DesignParkingLot {
    ...
    static class ParkingLot {
        ...
        public void addParkingSpot(int floor , int spot){
            if(floor > maxFloors){
                throw new IllegalStateException("floor input greater than max not allowed");
            }
            if(spot > spotsPerFloor){
                throw new IllegalStateException("spot input greater than max not allowed");
            }
